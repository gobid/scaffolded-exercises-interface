...
<p id='centre_last_p'>centre_last = <span className ="pt" id='centre_last'> </span> </p><HAButton id="centre_last_button"/> Note undoing and then redoing can annotate/highlight new elements on the page.
<p id='centre_p'>centre = <span className ="pt" id='centre'> </span> </p><HAButton id="centre_button"/> Note undoing and then redoing can annotate/highlight new elements on the page.
...
<p id='name_p'>name = <span className ="pt" id='name'> </span> </p><HAButton id="name_button"/> Note undoing and then redoing can annotate/highlight new elements on the page.
...
<p id='dimage_p'>$image = <span className ="pt" id='dimage'> </span> </p><HAButton id="dimage_button"/> Note undoing and then redoing can annotate/highlight new elements on the page.
                    ...
                    <div className="reflection-area">
                        ...
                        <textarea className="reflection-textarea" rows="6"></textarea>
                        <p>What is the relationship between the following variables: position, tilesize, centre_last, name, tile, $image, $remove, $map, centre? </p>
                        <textarea className="reflection-textarea" rows="6"></textarea>
                    </div>
